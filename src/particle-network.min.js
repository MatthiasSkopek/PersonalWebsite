...
(function (factory) {
  ...
  ParticleNetwork.prototype.init = function () {
    ...
    this.canvas.width = this.canvasDiv.size.width*2;
    this.canvas.height = this.canvasDiv.size.height*2;
    this.setStyles(this.canvasDiv, { 'position': 'relative' });
    this.setStyles(this.canvas, {
      'z-index': '20',
      'position': 'relative',
      'width': this.canvasDiv.size.width,
      'height': this.canvasDiv.size.height
    });
